...
+(DemoHintView*) infoHintView
{
    ...
    basicHintView.hintView.presentationAnimation = kHintViewPresentationDrop;
    basicHintView.hintView.backgroundImage = [UIImage imageNamed:@"pattern1.jpg"];
    
     basicHintView.icon = [UIImage imageNamed:@"touchbee_small.png"];
...
-(id)init
{
    ...
    if( self )
    {
        self.hintView = [[[TBHintView alloc] initWithFrame:CGRectMake(0, 0, 768, 1024)] autorelease];
