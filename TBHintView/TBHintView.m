...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) 
    {
        ...
        self.spanWidthWeight = 12.0f;
        self.layer.cornerRadius = 12.0;
        self.maximumHeight = 200.0f;
...
-(UIImageView *)imageViewTitleIcon
{
    if( !imageViewTitleIcon ) 
    {
        ...
        imageViewTitleIcon = [[UIImageView alloc] initWithFrame:CGRectMake( 8, 10 + yOffset, 200, 60)];
...
-(UILabel *)labelTitle
{
    ...
    { 
        ...
        labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(320, 30 + yOffset, 244, 21)];
        ...
        labelTitle.font = [UIFont boldSystemFontOfSize:30.0];
    ...
    for( NSUInteger page = 0; page < numberOfPages; page++ )
    {
        if( self.dataSource && [self.dataSource respondsToSelector:@selector(textForPage:hintView:)] )
        {
            ...
            if( pageContent )
            {
                ...
                labelText.font = [UIFont systemFontOfSize:30.0f];
